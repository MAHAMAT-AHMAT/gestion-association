...
// Définir l'interface pour les accessoires
interface HeaderProps {
  onClick?: () => void; // Fonction optionnelle qui ne prend aucun argument et renvoie void
  onToggle: () => void;
}
      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            {/* <!-- Basculeur de mode sombre --> */}
            <ThemeToggleButton />
            {/* <!-- Zone de menu de notification --> */}
