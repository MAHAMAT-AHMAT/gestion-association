...
export default function EleveList() {
  ...
  // Filter eleves by first letter or substring (nom, prenom)
  const filteredEleves = eleves.filter((eleve) =>
    search
      ? eleve.nom.toLowerCase().startsWith(search.toLowerCase()) ||
        eleve.prenom.toLowerCase().startsWith(search.toLowerCase())
      : true
  );
